...
rm -rf $KSROOT/bin/uridecoder >/dev/null 2>&1
...
cp -rf /tmp/koolclash/bin/uridecoder_linux_amd64 $KSROOT/bin/uridecoder
...
# 自带默认的 default_clash.yaml
[[ -f /tmp/koolclash/koolclash/config/default_clash.yaml ]] && cp -f /tmp/koolclash/koolclash/config/default_clash.yaml $KSROOT/koolclash/config/
[[ -f /tmp/koolclash/koolclash/config/default_clash.yaml ]] && cp -f /tmp/koolclash/koolclash/config/default_clash.yaml $KSROOT/koolclash/config/origin.yml
[[ -d /tmp/koolclash/koolclash/config/providers ]] && cp -rf /tmp/koolclash/koolclash/config/providers $KSROOT/koolclash/config/
[[ -d /tmp/koolclash/koolclash/config/ruleset ]] && cp -rf /tmp/koolclash/koolclash/config/ruleset $KSROOT/koolclash/config/
...
chmod 755 $KSROOT/bin/clash $KSROOT/bin/yq $KSROOT/bin/uridecoder
chmod 755 $KSROOT/scripts/koolclash_*.sh
...
sh $KSROOT/scripts/koolclash_main.sh init
sleep 1
